...
# 
# dbrady 2008-10-09: Screw THAT. I've spent the past two hours
# installing and configuring CPAN just so I can add a new "rails" type
# to this. When it was all done, it STILL didn't work. So you know
# what? Screw this, screw CPAN, and screw Ack. This is MY patched
# version, all you kids get off my lawn. All credit for cool stuff
# here goes to Ack's author. All bad stuff introduced by me is my
# fault. 
# 
# dbrady 2008-10-21: Added 'coverage' to the default list of ignored
# folders. You can force it to be re-included in the standard ways.
