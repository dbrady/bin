...
# 2016-01-24 dbrady: Use this script if you want to annotate images with
# fonts/text from ImageMagick on OSX and you're getting "unable to read font
# `(null)'" errors. Google will tell you you need to install freetype, but if
# you installed ImageMagick from homebrew, you already HAVE freetype.
#
# What you're missing is a typemap file for your system fonts. This script
# generates that file. Rerun it any time you add or change fonts.

# Original script here: http://iharder.sourceforge.net/current/macosx/imagesnap/
...
# That's it--you'll get a lot of warning messages but now your annotate commands
# will work. For example: I annotated a camera snapshot with a timestamp as
# follows:

# $ convert snapshot.jpg -gravity southeast -font Impact \
# -stroke '#000' -strokewidth 1 -annotate 0 '2016-01-23 14:06:00' \
# -stroke none -fill white -annotate '0' '2016-01-23 14:06:00' anno_snapshot.jpg
